...
export default function Profile() {
    ...
    const { connection, getUserData, address } = context;
            ...
            <div className='main' key={uri}>
                ...
                <div className='maincontent'>
                    <div className="userProfile" >
                        <img className='userchannellogo' src={generator.generateRandomAvatar(uri)} alt='channel logo' />

                        <div className='userchannelname' >{uri}</div>
                        <br />
                    </div>
                                    ...
                                    <Link to={`/video/${elem.globalId}`}>
                                        ...
                                        <div className='cardcolumn'>
                                            <div className='columnlogo'>
                                                <img className='channellogo' src={generator.generateRandomAvatar(uri)} alt='channel logo' />
                                            </div>
